...
public class SessionServlet extends HttpServlet {
     ...
     * 
     * MÉTODO DOPOST DEL INICIO DE SESIÓN (AUTENTICACIÓN DE USUARIOS)
     * 
     * ACORDE AL PARÁMETRO RECIBIDO, SE PUEDE REGISTRAR UN USUARIO Y VALIDAR SI
     * SE ESTÁ REGISTRANDO UN CLIENTE, UNA TIENDA O UN ADMINISTRADOR,
     * DEPENDIENDO DE LA ACCIÓN, SE REDIRIGE A LA PÁGINA PRIVILEGIADA
     * CORRESPONDIENTE
     *
     * @param request servlet request
     * @param response servlet response
